...
Revision ID: a603c8ce5e65
Revises: 
Create Date: 2026-04-19 06:06:43.777942
...
def upgrade() -> None:
    ...
    op.create_index('chunk_asset_id_idx', 'chunks', ['chunk_asset_id'], unique=False)
    op.create_index('chunk_project_id_idx', 'chunks', ['chunk_project_id'], unique=False)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('chunk_project_id_idx', table_name='chunks')
